return {
  ...
  config = function()
    ...
    --- Trigger a prompt-based interaction with the 99 AI plugin using visual selection
    --- This allows you to ask questions or make requests about the selected code
    vim.keymap.set('v', '<leader>9p', function()
      _99.visual_prompt(ops)
    end)
